...
======================================================================================================*/
	...
	bindEvents: function() { 
		...
		$("#validateTxnBtn").click(App.ExeValidateTxn);
...
/*======================================================================================================
	...
	Gets the user hash corresponding to the user id POSTed to '/submithash'
...
======================================================================================================*/
	...
	ExeRegisterUser: function (){
		...
		if(HASH == "Invalid value submitted") {
			App.showError('Valid hash value is required');
			return;
		}
...
======================================================================================================*/
	...
	CallRegStatus : function (){
		...
		// If value POSTed to '/submithash' was invalid, show message accordingly
		const HASH = $('#userHash').val();
		if(HASH == "Invalid value submitted") {
			App.showError('Valid hash value is required');
			return;
...
/*======================================================================================================
    TXN VALIDATION : Checks whether the 2 users are allowed to transact
======================================================================================================*/

    ExeValidateTxn: function(){
		console.log("In app.js ExeValidateTxn");
		...
		if (ID1 && ID2){
			...
			web3.eth.getAccounts(function (error,accounts){
			if (error){
				console.log("ERROR ExeValidateTxn");
				App.showError(error);
			}
			App.currentAccount = accounts[0];
